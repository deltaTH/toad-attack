  ...
  class Player {
    ...
    draw(context) {
      ...
      if (this.game.debug) {
        ...
        context.save(); //only affecting the next line upto fill
    ...
    update() {
      ...
      this.game.obstacles.forEach((obstacle) => {
        ...
        //let colision = game.checkCollision(this, obstacle)[0];
    ...
    update() {
      ...
      this.game.enemies.forEach((enemy) => {
        if (this.game.checkCollision(this, enemy)[0] && !this.game.gameOver) {
          ...
          for (let i = 0; i < 5; i++) {
            this.game.particles.push(
              new Spark(this.game, this.collisionX, this.collisionY, "orange")
            );
          }
        }
      });
  ...
  class Game {
    ...
    render(context, deltaTime) {
      if (this.timer > this.interval) {
        ...
        //* Now we will sort this array vertically to create a 3D effect
        ...
        // this.player.update();
        //player ko ek layer neeche daalne ke liye
      ...
      if(this.score >= this.winningScore){
        ...
        if(this.lostHatchlings <= 5){
          message1 = "Bullseye!";
          message2 = "You saved the day!";
        }
        else{
          message1 = "uh oh!";
          message2 = "You lost "+ this.lostHatchlings +" hatchlings!, try pushing HARDER!";
        }
